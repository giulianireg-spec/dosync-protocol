...
REAL_REGISTRY = [
    ...
    CapabilityManifest("ha-light-tv_generic_ambilight", "TV generic Ambilight",
        ["climate","light"],
    ...
    CapabilityManifest("ha-media_player-tv_generic", "TV generic",
        ["communication","display"],
        [ActuatorSpec(a) for a in ["turn_on","turn_off","display"]],
        emergency_capable=False, adapter="homeassistant"),
    CapabilityManifest("ha-switch-tv_generic_screen_state", "TV generic Screen state",
    ...
    CapabilityManifest("ha-sensor-wiz_rgbw_tunable_ac4864_power", "WiZ AC4864 Power",
        ["sensor"], [], adapter="homeassistant"),
    CapabilityManifest("ha-binary_sensor-tv_generic_recording_ongoing", "TV generic Recording ongoing",
        ["sensor"], [], adapter="homeassistant"),
    CapabilityManifest("ha-binary_sensor-tv_generic_new_recording_available", "TV generic New recording",
        ["sensor"], [], adapter="homeassistant"),
    CapabilityManifest("bridged-mediaplayer-02", "Bridged media player 2",
        ["communication","display"],
        [ActuatorSpec(a) for a in ["turn_on","turn_off","display"]],
        emergency_capable=False, adapter="homeassistant"),
